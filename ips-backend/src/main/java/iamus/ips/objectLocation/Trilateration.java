...
public class Trilateration {
	public LatLng getLocationByTrilateration(
	        LatLng location1, double rssi1,
	        LatLng location2, double rssi2,
	        LatLng location3, double rssi3, float scale){
		double txPower = 2;
	    ...
	    distance1 = (distance1*100)/scale;
	    //DISTANCE BETWEEN POINT 2 AND MY LOCATION
	    distance2 = (distance2*100)/scale;
	    //DISTANCE BETWEEN POINT 3 AND MY LOCATION
	    distance3 = (distance3*100)/scale;
